...
dep_map = (
    ...
    DepEntry("VideoEncoder", "VideoOptionExtraWindow", "x264|x264_10bit|qsv_h264|x265|x265_10bit|x265_12bit|x265_16bit|qsv_h265|qsv_h265_10bit|mpeg4|mpeg2|VP8|VP9", False, True),
    DepEntry("VideoEncoder", "VideoOptionExtraLabel", "x264|x264_10bit|qsv_h264|x265|x265_10bit|x265_12bit|x265_16bit|qsv_h265|qsv_h265_10bit|mpeg4|mpeg2|VP8|VP9", False, True),
